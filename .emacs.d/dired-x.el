...
<!-- saved from url=(0079)http://www.opensource.apple.com/source/emacs/emacs-56/emacs/lisp/dired-x.el?txt -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css"></style></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">;;; dired-x.el --- Extra Dired functionality -*-byte-compile-dynamic: t;-*-
